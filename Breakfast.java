...
public class Breakfast {
    ...
    public static final String MAIN = "Eggs";
    public static final String SIDE = "Toast";
    public static final String DRINK = "Coffee";
    public Map<String, Integer> items;

    public Breakfast(String[] orders)
    {
        this.orders = orders;
    ...
    public String printOrder()
    {
        ...
        //Must order a single main dish at breakfast, otherwise error
        if(items.containsKey(MAIN))
        {
            sb.append(MAIN + ", ");
            if(items.get(MAIN) > 1)
        ...
        //Must order a single side at breakfast, otherwise error
        if(items.containsKey(SIDE))
        {
            sb.append(SIDE);
            if(items.get(SIDE) > 1)
        ...
        //Can order multiple drinks at breakfast
        if(items.containsKey(DRINK))
        {
            sb.append(", " + DRINK);
            if(items.get(DRINK) > 1)
            {
                sb.append("(" + items.get(DRINK) + ")");
            }
        }
